<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="CcySemiAutoLimit.aspx.cs" Inherits="VPB_FX.Modules.DMS.CcySemiAutoLimit" %>
...
<legend class="divLegend">Hạn Mức Giao Dịch Bán Tự Động</legend>
<table style="width:100%">  
    <tr>
        <td style="width: 100px">Loại tiền tệ</td>
        <td>
            <asp:DropDownList ID="drCcy" runat="server" Width="200px" SkinID="DropDownList" Font-Size="Large">
            </asp:DropDownList>                
        </td>            
    </tr>        
    <tr>
        ...
        <td>
            <asp:DropDownList ID="drtxnType" runat="server" Width="200px" SkinID="DropDownList" Font-Size="Large">
            </asp:DropDownList>                
        </td> 
    </tr>
    <tr>
        <td style="width: 100px">Hạn mức</td>
        <td><cc1:C1WebNumericEdit UpDownAlign="None" ID="txtAmount" runat="server" Text='' DecimalPlaces="0" Width="200px"  ThousandsSeparator="true" Culture="en-US" Value="0" SmartInputMode="true" MinValue="0" Font-Size="Large"></cc1:C1WebNumericEdit></td>
    </tr>
    <tr>
...
<fieldset class="fieldsetBg">
<legend class="divLegend">Các Hạn Mức Giao Dịch Bán Tự Động</legend>
<table class="Table" style="width:100%">
        <tr>
            <td>
                <asp:ObjectDataSource runat="server" ID="ObjectDataSource1" SelectMethod="getListCcySemiAutoLimit" TypeName="DataSource">
                    <SelectParameters>
                    </SelectParameters>
...
<script language="javascript" type="text/javascript">
    ...
    function Authorize(Ccy, txnType) {
        ...
        $.ajax({
            ...
            success: function(errormessage) {
                if (errormessage == "") {
                    alert("Đã duyệt hạn mức bán tự động.");
