...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
    ...
    <asp:Timer ID="Timer1" runat="server" OnTick="LoadData" Interval="1000">
    </asp:Timer>
    <table width="100%">
        <tr>
                                        ...
                                        <C1WebGrid:C1WebGrid runat="server" ID="dataCtrlhg" Width="100%" OnItemCreated="dataCtrl_OnItemCreated"
                                            ...
                                            <Columns>
                                                <C1WebGrid:C1TemplateColumn>
                                                    <ItemStyle Width="4%" />
                                                    <ItemTemplate>
                                                        <asp:Image runat="server" ImageUrl="~/App_Themes/Default/Images/delete.gif"
                                                            ToolTip="Xóa" ID="imgDel" Style="cursor: pointer;" />
