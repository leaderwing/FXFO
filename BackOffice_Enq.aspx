<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="BackOffice_Enq.aspx.cs" Inherits="VPB_FX.Modules.DMS.BackOffice_Enq" %>
...
<link type="text/css" rel="Stylesheet" href="../../Css/bootstrap.min.css"></link>
    ...
    <div class="form-horizontal">
        <div class="form-group">
            <div class="col-sm-10">
                <asp:CheckBoxList runat="server" ID="chkSegment" RepeatDirection="Vertical" RepeatColumns="7">
                    <asp:ListItem Text="CIB" Value="CIB"></asp:ListItem>
                    <asp:ListItem Text="CMB" Value="CMB"></asp:ListItem>
                    <asp:ListItem Text="KHCN" Value="KHCN"></asp:ListItem>
                    <asp:ListItem Text="SME Diamond" Value="SMEdiamond"></asp:ListItem>
                    <asp:ListItem Text="SME Platinum" Value="SMEplatinum"></asp:ListItem>
                    <asp:ListItem Text="SME Gold" Value="SMEGold"></asp:ListItem>
                    <asp:ListItem Text="SME Silver" Value="SMESilver"></asp:ListItem>
                </asp:CheckBoxList>
            </div>
            <div>
            </div>
                            ...
                            <td>
                                ...
                                <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                                    ...
                                    <Columns>
                                        ...
                                        <C1WebGrid:C1BoundColumn DataField="ID FX ĐVKD-HO" HeaderText="FX HO" SortExpression="Value" Visible="false">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function report() {
            ...
            var elementRef = document.getElementById("ctl00_FormContent_chkSegment");
            ...
            if (checkedValues.length == 0) {
                alert('Bạn cần lựa chọn Phân khúc khách hàng muốn truy vấn');
                return false;
            }
            alert(selected);
            var segment = checkedValues;
            //segment = segment.toString().replace(',', "'',''");
            var url = "BackOffice_Enq.aspx";
            var query = "act=report";
            query += "&segment=" + segment + "&status=" + status;
