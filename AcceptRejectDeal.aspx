<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true"
    CodeBehind="AcceptRejectDeal.aspx.cs" Inherits="VPB_FX.Modules.DMS.AcceptRejectDeal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function AcceptReject() {
            ...
            var query = "auto=" + '<%=_auto %>' + "&dealid=" + '<%=_dealid %>' + "&txntype=" + '<%=_type %>' + "&act=Accept&rate=" + rate;
