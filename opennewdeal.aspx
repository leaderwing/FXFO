<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true"
    CodeBehind="opennewdeal.aspx.cs" Inherits="VPB_FX.Modules.DMS.opennewdeal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
        ...
        <table style="width: 100%">
            ...
            <tr>
             ...
             <tr>
                ...
                <td colspan="3">
                    <asp:TextBox Width="80%" ID="txtCommment" TextMode="MultiLine" Rows="2"  runat="server" SkinID="TextBox" Font-Size="Larger" Style="text-transform: uppercase"
                        ></asp:TextBox>
                </td>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fulfilmentDeal() {
            ...
            var comment = GetSvrCtlValue("txtCommment");
            var fw_dealer = "";
            if (amt <= 0) {
            ...
            fulfilmentDealInfo(dealdate, valuedate, txnType, buyorsell, amt, ccyBuy, ccySell, cif, cifname, cifrate, objType, book, seg, rank, dao, daoname, comment);
        }
        /*****************************************/
        ...
        /*****************************************/
        function fulfilmentDealInfo(dealdate, valuedate, txnType, buyorsell, amt, ccyBuy, ccySell, cif, cifname, cifrate, objType, book, seg, rank, dao, daoname, comment) {
            var url = "opennewdeal.aspx";
            ...
            if (objType == "DIRECT SALES" || (seg + rank == "KHCNGOLD") && objType == "KHCN" || (seg + rank == "KHCNGOLD - SPECIAL") && objType == "KHCN" || seg == "KNV" || (seg == "AF" && objType == "KHCN")) {
                ...
                hoigia(url, JSONObject, txnType, objType);
            } else {
        ...
        function processDeal() {
            ...
            $.ajax({
                ...
                //data: query,
                datatype: "json",
                data: { act: "createfx", rate: replaceNumber(GetSvrCtlValue("txtTyGia"), ",", ""), limit: GetSvrCtlValue("txtLimitType"), amtbuy: GetSvrCtlValue("txtSoLuongMua"), amtsell: GetSvrCtlValue("txtSoLuongBan"), company: $("#<%=lblCompany.ClientID %>").text(), comment: GetSvrCtlValue("txtCommment") },
                success: function (errormessage) {
                    FinishProcessingForm();                  
        ...
        function finishDeal() {
            ...
            $.ajax({
                ...
                url: url,
                datatype: "json",
                data: { act: "branchconfirm", dealid: dealid, comment: comment },
                //data: query,
                success: function (errormessage) {
        ...
        function requestRate() {
            ...
            $.ajax({
                ...
                url: url,
                datatype: "json",
                data: { act: "requestrate", dealid: dealid, comment: comment },
                //data: query,
                success: function (errormessage) {
                    if (errormessage == "") {
                        window.opener = null;
