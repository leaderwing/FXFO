<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true"
    CodeBehind="dealpendingfordelete.aspx.cs" Inherits="VPB_FX.Modules.DMS.dealpendingfordelete" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
                            ...
                            <fieldset class="fieldsetBg">
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr id="trFW">
                                        ...
                                        <td style="width: 188px;color:red" id="tdForwardDate">
                                            &nbsp;
                                        </td>
                                    </tr>
                                    <tr>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showdealinfo(dealid) {
            _dealid = dealid;
            var url = "dealpendingfordelete.aspx";
