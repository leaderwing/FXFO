<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true"
    CodeBehind="dealpendingforrate.aspx.cs" Inherits="VPB_FX.Modules.DMS.dealpendingforrate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    <fieldset class="fieldsetBg">
                                        ...
                                        <asp:ListBox runat="server" ID="lstDeals" Rows="20" Width="100%" CssClass="divLegend"
                            ...
                            <fieldset class="fieldsetBg">
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 188px" id="tdTradeDate">
                                            &nbsp;
                                        </td>
                                        <td style="width: 100px" class="lblCaption">
                                            Ngày giá trị
                                        </td>
                                        <td id="tdValueDate" style="width: 279px">
                                            &nbsp;
                                        </td>
                                    </tr>
                                     <tr id="trFW">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr id="RateSW">
                                        ...
                                        <td style="width: 279px">
                                            <cc1:C1WebNumericEdit ID="spRate" runat="server"
                                                Width="100%" Height="40px" Font-Size="Large" Text="0" DecimalPlaces="4" Culture="en-US"
                                                ThousandsSeparator="true" Value="0" SmartInputMode="false" MaxValue="500000000000"
                                                UpDownAlign="None" >
                                            </cc1:C1WebNumericEdit>
                                        ...
                                        <td style="width: 279px">
                                            <cc1:C1WebNumericEdit ID="fwRate"  runat="server"
                                                Width="100%" Height="40px" Font-Size="Large" Text="0" DecimalPlaces="4" Culture="en-US"
                                                ThousandsSeparator="true" Value="0" SmartInputMode="false" MaxValue="500000000000"
                                                UpDownAlign="None" >
                                            </cc1:C1WebNumericEdit>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showfirstDeal() {
            var ctlid = "<%=lstDeals.ClientID %>";
            var dealid = new String($("#" + ctlid + " option:selected").val());
