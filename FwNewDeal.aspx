<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="FwNewDeal.aspx.cs" Inherits="VPB_FX.Modules.DMS.FwNewDeal" %>
...
<fieldset class="fieldsetBg2">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 418px">
                    ...
                    &nbsp;
                    <asp:Button runat="server" ID="btnChangeBook" CssClass="Button" Text="<< Chuyển book"
                        Visible="false" OnClientClick="{showchangeBook();return false;}" />
                </td>
                ...
                <td style="width: 197px" valign="top" align="right">
                    <asp:Label runat="server" ID="lblDealStatus" Style="text-transform: uppercase; font-weight: bold;"
                        EnableViewState="false" Text="Mở mới"></asp:Label>
                </td>
            </tr>
            <tr>
    ...
    <fieldset class="fieldsetBg">
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 213px">
                    <asp:DropDownList ID="cboBuyOrSell" runat="server" SkinID="DropDownListRequired"
                        Font-Size="Larger">
                    </asp:DropDownList>
                </td>
                <td style="width: 92px">
                ...
                <td>
                    <asp:TextBox ID="txtDealDate" runat="server" SkinID="TextBoxDateRequired" Style="text-transform: uppercase"
            ...
            <tr>
                ...
                <td style="width: 213px">
                    <asp:DropDownList ID="cboCCYBuy" runat="server" SkinID="DropDownListRequired" Font-Size="Larger">
                    </asp:DropDownList>
                </td>
                <td style="width: 92px">
                    Đồng Bán
                ...
                <td>
                    <asp:DropDownList ID="cboCCYSell" runat="server" SkinID="DropDownListRequired" Font-Size="Larger">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function getcifInfo() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var acif = JSON.parse(data);
                    SetSvrCtlValue("txtCIF_Name", acif.CifName);
        ...
        function getCCYBuy_Sell() {
            ...
            if ((ccyPair == "USDVND") || (ccyPair == "VNDUSD")) {
                $("#ctl00_FormContent_btnQuesFW").hide();
        ...
        function fulfilmentDeal() {
            ...
            if (_objtype == "DIRECT SALES") {
                if ("CIB.CMB".lastIndexOf(GetSvrCtlValue("txtSegment").toUpperCase()) > 0) {
                    alert('Phân khúc KH không thuộc phân quyền xử lý');
                    return false;
                }
                if ("DIAMOND".lastIndexOf(GetSvrCtlValue("txtRank").toUpperCase()) == -1) {
                    alert('Phân khúc KH không thuộc phân quyền xử lý');
                    return false;
                }

            } else if (_objtype != GetSvrCtlValue("txtSegment").toUpperCase()) {
                alert('Phân khúc KH không thuộc phân quyền xử lý');
                return false;
            } else {
                if (_objtype == "SME") {
            ...
            fulfilmentDealInfo(dealdate, valuedate, txnType, buyorsell, amt, ccyBuy, ccySell, cif, cifname, cifrate, objType, book, seg, rank);
        }
        /*****************************************/
        ...
        /*****************************************/
        function fulfilmentDealInfo(dealdate, valuedate, txnType, buyorsell, amt, ccyBuy, ccySell, cif, cifname, cifrate, objType, book, seg, rank) {
            var url = "opennewdeal.aspx";
            ...
            else if ((txnType == "SP") && (objType == "SME")) {
                url += "?" + query;
            ...
            $.ajax({
                ...
                success: function (errormessage) {
                    ...
                    if (errormessage.length == 36) {
                        ...
                        window.opener = null;
                        window.close(true);
                        opendetail("opendealcustomer.aspx?dealid=" + errormessage + "&txntype=" + '<%=_txntype %>', 'cu');
                    }
                    else {
            ...
            $.ajax({
                ...
                success: function (errormessage) {
                    ...
                    if (errormessage == "") {
                        ...
                        opendetail("opendealcustomer.aspx?dealid=" + dealid + "&txntype=" + '<%=_txntype %>', "customer");
        ...
        /*****************************************/
        function FXCustomer(id) {
            opendetail("opendealcustomer.aspx?dealid=" + id + "&txntype=" + '<%=_txntype %>', "customer");
        }
    </script>       
</asp:Content>
